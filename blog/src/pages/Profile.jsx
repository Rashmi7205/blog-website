    ...
    <div className="w-full ">
      {isEditing ? (
        ...
        <div className="w-full h-[1300px] md:h-screen relative">
          ...
          <div className="w-[100%] h-4/5 flex flex-col md:flex-row items-center justify-around absolute top-[70px]">
            <div className="w-full md:w-1/5 h-[100%] bg-slate-200 rounded-lg flex items-center justify-around flex-col ">
              <div className="w-full flex h-1/5 p-3 items-center justify-center">
                <img
              ...
              <div className="w-[90%] h-2/5 border-2 border-slate-400 rounded-md p-2">
                ...
                <div className="w-full my-3">
                  ...
                  <div className="w-full flex items-center justify-around text-2xl my-3 ">
              ...
              <div className="w-[90%] h-1/5 border-2 border-slate-400 rounded-md flex items-center justify-around ">
                <button
