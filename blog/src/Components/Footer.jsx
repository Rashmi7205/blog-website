...
function Footer() {
  return (
    ...
    <div className="footer-content w-full flex  md:flex-row flex-col items-center justify-between">
      <div className="footer-logo w-2/5 flex items-center justify-around flex-col">
      ...
      <div className="footer-links w-1/5">
        <ul className='my-3 flex items-center justify-around flex-col h-full'>
      ...
      <div className="footer-social w-2/5 flex items-center justify-around text-2xl">
