...
function AboutPage() {
  return (
    <div className='w-full flex flex-col p-4 '>
        ...
        <p className='text-lg font-semibold py-5 first-letter:text-9xl first-letter:text-yellow-600 '>Welcome to Blog., your go-to destination for all things Blog.. We're thrilled you've stumbled upon our corner of the internet, and we can't wait to share our passion, knowledge, and insights with you.</p>
        </div>
        <div className='w-full md:w-2/3 my-5 '>
          ...
          At Blog., we're a team of  dedicated individuals who are united by a common love for Blog. . We come from diverse backgrounds, each bringing a unique perspective and expertise to the table. Our combined experiences and interests make our blog a dynamic hub for Blog. enthusiasts.
          </p>
        </div>
        ...
        <div className='w-full md:w-2/3 my-5 flex items-center justify-around md:flex-row flex-col h-[950px] md:h-auto'>
            ...
            <div className='w-[200px] h-[150px]'>
                  ...
                  '>Diversity</h1>
                  <p className='text-lg font-semibold'>With a diverse group of contributors, we offer a wide range of perspectives and expertise to cater to various interests within Blog.</p>
            </div>
            <div className='w-[200px] h-[150px]'>
